...
export const MiniPlayer = memo(function MiniPlayer() {
  ...
  const artistName = useMemo(() => {
    if (!item) return '';
    // Cast to any to access music-specific properties like Artists/AlbumArtist
    const musicItem = item as any;
    const artists = musicItem.Artists || (musicItem.AlbumArtist ? [musicItem.AlbumArtist] : []);
    const displayArtists = getDisplayArtist(artists, hideMedia);
