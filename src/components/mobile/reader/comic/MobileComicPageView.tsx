...
interface MobileComicPageViewProps {
  page: ComicPage;
...
export function MobileComicPageView({
  page,
  composedGestures,
  animatedImageStyle,
  getContentFit,
  getImageStyle,
}: MobileComicPageViewProps) {
  return (
    <View
...
interface MobileComicDoublePageViewProps {
  pagePair: ComicPage[];
  composedGestures: ComposedGesture;
  animatedImageStyle: any;
}

export function MobileComicDoublePageView({
  pagePair,
  composedGestures,
  animatedImageStyle,
}: MobileComicDoublePageViewProps) {
  return (
    <View
