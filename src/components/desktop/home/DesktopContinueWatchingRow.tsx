      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.cardOverlay}>
          <View style={styles.cardContent}>
            <View style={[styles.playIconContainer, isActive && { backgroundColor: accentColor }]}>
...
export const DesktopContinueWatchingRow = memo(function DesktopContinueWatchingRow({
  items,
  onItemPress,
  rowIndex = 0,
  ...
  const getItemLayout = useCallback((_: any, index: number) => ({
    ...
    offset: (CARD_WIDTH + CARD_MARGIN) * index + HORIZONTAL_PADDING,
    index,
  }), []);
